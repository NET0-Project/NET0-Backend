...
-- item table
INSERT INTO item (SHOP_ID, NAME, ORIGIN_PRICE, PRICE, DISCOUNT_RATE, STOCK, EXP, ITEM_DESCRIPTION)
VALUES (1,'소금빵',2000,1000,50,1,'2024-05-30','따끈따끈 소금빵');

INSERT INTO item (SHOP_ID, NAME, ORIGIN_PRICE, PRICE, DISCOUNT_RATE, STOCK, EXP)
